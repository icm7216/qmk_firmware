...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |  C+z |   ;  |   [  |   (  |   <  |   {  |             |  C+z |   ;  |   [  |   (  |   <  |   {  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | KANA |   P  |   K  |   R  |   A  |   F  |             | KANA |   P  |   K  |   R  |   A  |   F  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |  BS  |   D  |   T  |   H  |   E  |   O  |             |  BS  |   D  |   T  |   H  |   E  |   O  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Y  |   S  |   N  |   I  |   U  |Space |Space | Shift|   Y  |   S  |   N  |   I  |   U  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  | Gui  | Sym  | Num  | OPT  | Ent  | Ent  | Ctrl | Alt  | Gui  | Sym  | Num  | OPT  |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_BASE] = LAYOUT( \
      LCTL(KC_Z),   KC_SCLN,      KC_LBRC,      KC_LPRN, KC_LT,   KC_LCBR,                  LCTL(KC_Z),   KC_SCLN,      KC_LBRC,      KC_LPRN, KC_LT,   KC_LCBR, \
      KANA,         KC_P,         KC_K,         KC_R,    KC_A,    KC_F,                     KANA,         KC_P,         KC_K,         KC_R,    KC_A,    KC_F, \
      KC_BSPC,      KC_D,         KC_T,         KC_H,    KC_E,    KC_O,                     KC_BSPC,      KC_D,         KC_T,         KC_H,    KC_E,    KC_O, \
      OSM(MOD_LSFT),KC_Y,         KC_S,         KC_N,    KC_I,    KC_U,      KC_SPC, KC_SPC,OSM(MOD_LSFT),KC_Y,         KC_S,         KC_N,    KC_I,    KC_U, \
      OSM(MOD_LCTL),OSM(MOD_LALT),OSM(MOD_LGUI),MO(_SYM),MO(_NUM),OPT_TAP_SP,KC_ENT, KC_ENT,OSM(MOD_LCTL),OSM(MOD_LALT),OSM(MOD_LGUI),MO(_SYM),MO(_NUM),OPT_TAP_SP \
      ),
   ...
   * |  Esc |  :   |  ]   |  )   |  >   |  }   |             |  Esc |  :   |  ]   |  )   |  >   |  }   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |  EISU|   J  |   M  |   B  |   '  |  Tab |             |  EISU|   J  |   M  |   B  |   '  |  Tab |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |   .  |   V  |   C  |   L  |   Z  |  Q   |             |   .  |   V  |   C  |   L  |   Z  |  Q   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |   X  |   G  |   W  |   -  |  Del | Esc  | Esc  |      |   X  |   G  |   W  |   -  |  Del |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |   ,  | DTOP |      |      |      |      |      |      |   ,  | DTOP |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_OPT] = LAYOUT( \
      KC_ESC,  KC_COLN, KC_RBRC, KC_RPRN, KC_GT,    KC_RCBR,                   KC_ESC,  KC_COLN, KC_RBRC, KC_RPRN, KC_GT,    KC_RCBR, \
      EISU,    KC_J,    KC_M,    KC_B,    KC_QUOT,  KC_TAB,                    EISU,    KC_J,    KC_M,    KC_B,    KC_QUOT,  KC_TAB, \
      KC_DOT,  KC_V,    KC_C,    KC_L,    KC_Z,     KC_Q,                      KC_DOT,  KC_V,    KC_C,    KC_L,    KC_Z,     KC_Q, \
      _______, KC_X,    KC_G,    KC_W,    KC_MINUS, KC_DEL,  KC_ESC,  KC_ESC,  _______, KC_X,    KC_G,    KC_W,    KC_MINUS, KC_DEL, \
      _______, _______, _______, KC_COMM, DESKTOP,  _______, _______, _______, _______, _______, _______, KC_COMM, DESKTOP,  _______ \
      ),

  /* Func
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |RGBRST|  Hue |      |  RST |  Mac |  Win |             |RGBRST|  Hue |      |  RST |  Mac |  Win |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | RGB1 | VAL+ |  F7  |  F8  |  F9  |      |             | RGB1 | VAL+ |  F7  |  F8  |  F9  |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | RGB2 | VAL- |  F4  |  F5  |  F6  | F12  |             | RGB2 | VAL- |  F4  |  F5  |  F6  | F12  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | RGB3 |  F10 |  F1  |  F2  |  F3  | F11  |      |      | RGB3 |  F10 |  F1  |  F2  |  F3  | F11  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |RGBOFF|      |      |      |      |      |      |      |RGBOFF|      |      |      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_FUNC] = LAYOUT( \
      RGBRST, RGB_HUI, _______, RESET,   MAC,     WIN,                         RGBRST, RGB_HUI, _______, RESET,   MAC,     WIN, \
      RGB1,   RGB_VAI, KC_F7,   KC_F8,   KC_F9,   _______,                     RGB1,   RGB_VAI, KC_F7,   KC_F8,   KC_F9,   _______, \
      RGB2,   RGB_VAD, KC_F4,   KC_F5,   KC_F6,   KC_F12,                      RGB2,   RGB_VAD, KC_F4,   KC_F5,   KC_F6,   KC_F12, \
      RGB3,   KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_F11,   _______,  _______, RGB3,   KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_F11, \
      RGBOFF, _______, _______, _______, _______, _______,  _______,  _______, RGBOFF, _______, _______, _______, _______, _______ \
      ),

  /* Sym
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |  Ins |  GRV |      |  PU  |  PD  |   ^  |             |  Ins |  GRV |      |  PU  |  PD  |   ^  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   \  |   #  |   =  |   ?  |   %  |             |      |   \  |   #  |   =  |   ?  |   %  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   $  |  upA |   @  |   !  |   |  |             |      |   $  |  upA |   @  |   !  |   |  |
   ...
   */
  [_SYM] = LAYOUT( \
      KC_INS,  KC_GRV,  _______, KC_PGUP, KC_PGDN, KC_CIRC,                   KC_INS,  KC_GRV,  _______, KC_PGUP, KC_PGDN, KC_CIRC, \
      _______, KC_BSLS, KC_HASH, KC_EQL,  KC_QUES, KC_PERC,                   _______, KC_BSLS, KC_HASH, KC_EQL,  KC_QUES, KC_PERC, \
      _______, KC_DLR,  KC_UP,   KC_AT,   KC_EXLM, KC_PIPE,                   _______, KC_DLR,  KC_UP,   KC_AT,   KC_EXLM, KC_PIPE, \
      KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_UNDS, KC_AMPR, _______, _______, KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_UNDS, KC_AMPR, \
      _______, _______, KC_PSCR, _______, KC_TILD, _______, _______, _______, _______, _______, KC_PSCR, _______, KC_TILD, _______ \
      ),

  /* Raise
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |      |      | Func | home |  End |      |             |      |      | Func | home |  End |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   *  |  7   |  8   |  9   |  -   |             |      |   *  |  7   |  8   |  9   |  -   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |  .   |   /  |  4   |  5   |  6   |  +   |             |  .   |   /  |  4   |  5   |  6   |  +   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |  LN  |  0   |  1   |  2   |  3   |C+S+F1|      |      |  LN  |  0   |  1   |  2   |  3   |C+S+F1|
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |  ,   |      |      |      |      |      |      |      |  ,   |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_NUM] = LAYOUT( \
      _______, _______, OSL(_FUNC), KC_HOME, KC_END,  _______,                          _______, _______, OSL(_FUNC), KC_HOME, KC_END,  _______, \
      _______, KC_ASTR, KC_P7,      KC_P8,   KC_P9,   KC_MINS,                          _______, KC_ASTR, KC_P7,      KC_P8,   KC_P9,   KC_MINS, \
      KC_PDOT, KC_SLSH, KC_P4,      KC_P5,   KC_P6,   KC_PLUS,                          KC_PDOT, KC_SLSH, KC_P4,      KC_P5,   KC_P6,   KC_PLUS, \
      KC_NLCK, KC_P0,   KC_P1,      KC_P2,   KC_P3,   LCTL(S(KC_F1)), _______, _______, KC_NLCK, KC_P0,   KC_P1,      KC_P2,   KC_P3,   LCTL(S(KC_F1)), \
      _______, _______, KC_PDOT,    KC_COMM, _______, _______,        _______, _______, _______, _______, KC_PDOT,    KC_COMM, _______, _______ \
      )
};
#else
